jQuery(document).ready(function ($) {
    "use strict";
    function srizon_google_maps() {
        if ($('.srizon-google-maps').length <= 0) {
            return;
        }
        $('.srizon-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function srizon_init_menu_toggle() {
        var contain = '.srizon-nav-toggle';
    ...
    // ----------srizon_custom_scrollbar-------------------
    function srizon_custom_scrollbar() {
        $('.srizon-mini-cart .minicart-items').mCustomScrollbar();
        $('.srizon-mini-cart .minicart-items').change(function () {
            $('.srizon-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function srizon_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function srizon_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function srizon_remove_class_review() {
    ...
    // -----------srizon_details_thumd--------------------
    function srizon_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function srizon_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.srizon-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.srizon-dropdown');
            var _allparent = $('.srizon-dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-srizon="srizon-dropdown"]') ||
                    $(event.target).closest('[data-srizon="srizon-dropdown"]').length > 0
                ) {
                    _target.toggleClass('open');
                    return false;
                }
            } else {
                $('.srizon-dropdown').removeClass('open');
            }
        });
    }

    function srizon_mobile_block() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function srizon_tab_fade_effect() {
        // effect click
        $(document).on('click', '.srizon-tabs .tab-link a', function () {
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function srizon_countdown() {
        if ($('.srizon-countdown').length > 0) {
            ...
            $('.srizon-countdown').each(function () {
    ...
    $(window).resize(function () {
        ...
        srizon_masonry()
        kt_resizeMegamenu();
        srizon_remove_class_review();
        srizon_details_thumd_zoom();
        srizon_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
    ...
    srizon_masonry()
    srizon_dropdown();
    srizon_init_carousel();
    srizon_remove_class_review();
    srizon_tab_fade_effect();
    srizon_details_thumd_zoom();
    srizon_video();
    kt_resizeMegamenu();
    srizon_custom_scrollbar();
    srizon_countdown();
    srizon_init_menu_toggle();
    srizon_custom_scrollbar_header_nav();
}); 